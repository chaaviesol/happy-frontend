...
export default function Product_Listing_sec() {
  ...
  useEffect(() => {
    ...
    axiosPrivate.post(`/product/prodlist`).then((res) => {
      // console.log("res====>", res.data);
      console.log(res)
      setproduct_listing_dt(res.data);
      setTempSoringList(res.data);
      if (res.data) {
        settrfls(true);
      }
    });
  ...
  const addQuantityFn = (e) => {
    ...
    if (value <= 10000) {
      ...
      toast.warning("Please ensure the input quantity is less than 10000", {
        position: "top-right",
        autoClose: 3000,
        hideProgressBar: false,
        closeOnClick: true,
