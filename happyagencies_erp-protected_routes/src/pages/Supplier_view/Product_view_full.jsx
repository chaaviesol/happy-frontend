...
import Supllier_side_bar from '../../components/Suppliercomponent/Supllier_side_bar';
import Supplier_view from './Supplier_view';
import { useLocation } from 'react-router-dom';
import Add_supplier_product from './Add_supplier_product';
import Supplier_product_view from './Supplier_product_view';
export default function Product_view_full() {
            ...
            <div id="product_setting">
                ...
                >
                    <div id={isDrawerOpen == true ? "width_prod1" : "width_prod"}>
                        ...
                        >
                            {isDrawerOpen && <Supllier_side_bar />}
                        </div>
                    </div>
                </div>
                <div
                    id={isDrawerOpen == true ? "media_qry7" : "prdct_media_qry10"}
                    style={{
                        height: "100vh",
                    }}
                >
