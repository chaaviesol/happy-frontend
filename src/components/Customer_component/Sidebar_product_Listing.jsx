...
export default function Sidebar_product_Listing() {
        ...
        <div id='side_bar'>
          ...
          {state.myProfile == true ?
            <>
              <div id='side_bar_prdct_txt' >
                ...
                <span id='prdct_text_dec' onClick={()=>navigate("/customerprofile")}>Profile</span>
              </div>
              <div style={{ height: "0.5rem" }}></div>
              <div id='side_bar_prdct_txt' >
                <div id='dsply_none' style={{ width: "70px" }}></div>
                <span id='prdct_text_dec' href="">Support</span>
              </div>
              <br />
            </>
          ...
          {state.order == true ?
            <>
              <div id='side_bar_prdct_txt' >
                <div id='dsply_none' style={{ width: "70px" }}></div>
                <span id='prdct_text_dec' href="">New Order</span>
              </div>
              <div style={{ height: "0.5rem" }}></div>
              <div id='side_bar_prdct_txt' >
                <div id='dsply_none' style={{ width: "70px" }}></div>
                <span id='prdct_text_dec' href="">Past Order</span>
              </div>
              <div style={{ height: "0.5rem" }}></div>
              <div onClick={() =>  navigate("/customer_orders")} id='side_bar_prdct_txt'>
                <div id='dsply_none' style={{ width: "70px" }}></div>
                <span id='prdct_text_dec'>Works list</span>
              </div>
              <br />
            </>
            : ""}
          ...
          {state.serviceRequest == true ?
            <>
              <div id='side_bar_prdct_txt' >
                <div id='dsply_none' style={{ width: "70px" }}></div>
                <span id='prdct_text_dec' href="">New Service Request</span>
              </div>
              <div style={{ height: "0.5rem" }}></div>
              <div id='side_bar_prdct_txt' >
                <div id='dsply_none' style={{ width: "70px" }}></div>
                <span id='prdct_text_dec' href="">Past Service Request</span>
              </div>
              <br />
            </> : ""}
          <div id='side_bar_prdct'>
          ...
          {state.return == true ?
            <>
              <div id='side_bar_prdct_txt' >
                <div id='dsply_none' style={{ width: "70px" }}></div>
                <span id='prdct_text_dec' >New Return</span>
              </div>
              <div style={{ height: "0.5rem" }}></div>
              <div id='side_bar_prdct_txt' >
                <div id='dsply_none' style={{ width: "70px" }}></div>
                <span id='prdct_text_dec' href="">Past Return</span>
              </div>
              <br />
            </>
            : ""}
          <div id='side_bar_prdct'>
            ...
            &nbsp;&nbsp;
            &nbsp; <span id='btn_set_prdct_help' href="">Help</span>
          </div>
        </div>
      </div>
    </>
